...
//
// Base tags have bSize = 0. The sized variants OR in the data length.
...
mod tests {
    ...
    /// Original PoC descriptor bytes. Asserts the named-constant rewrite is
    /// byte-for-byte identical.
    #[rustfmt::skip]
    const ORIGINAL: &[u8] = &[
        ,
        ...
        0x20, 0x4e, 0x75, 0x10, 0x55, 0x0e, 0x65, 0x11, 0x09, 0x30,
        0x46, 0x14, 0x05, 0x95, 0x01, 0x81, 0x02, 0x46, 0x52, 0x03,
        0x26, 0xe0, 0x2e, 0x09, 0x31, 0x81, 0x02, 0xc0,
        0x05, 0x0d, 0x09, 0x22, 0xa1, 0x02, 0x25, 0x01, 0x09, 0x47,
        0x09, 0x42, 0x95, 0x02, 0x75, 0x01, 0x81, 0x02, 0x75, 0x01,
        0x95, 0x06, 0x81, 0x03, 0x95, 0x01, 0x75, 0x20, 0x27, 0xff,
        0xff, 0xff, 0xff, 0x09, 0x51, 0x81, 0x02, 0x05, 0x01, 0x26,
        ...
        ,
    ];

    #[test]
    fn descriptor_matches_original() {
        assert_eq!(PTP_REPORT_DESCRIPTOR, ORIGINAL);
    }
}
