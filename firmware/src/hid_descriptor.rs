...
// ---------------------------------------------------------------------------
//
// Re-export base tags from esp32-nimble and define sized variants.
//
// The HID item byte format: bits 0–1 = bSize (0→0B, 1→1B, 2→2B, 3→4B),
// bits 2–3 = bType, bits 4–7 = bTag. The nimble constants encode bSize = 0;
// we OR in the actual size.
...
// 1-byte data (bSize = 1)
const USAGE_PAGE_8: u8 = USAGE_PAGE | 0x01;
const USAGE_8: u8 = USAGE | 0x01;
const LOGICAL_MINIMUM_8: u8 = LOGICAL_MINIMUM | 0x01;
const LOGICAL_MAXIMUM_8: u8 = LOGICAL_MAXIMUM | 0x01;
const PHYSICAL_MAXIMUM_8: u8 = PHYSICAL_MAXIMUM | 0x01;
const UNIT_EXPONENT_8: u8 = UNIT_EXPONENT | 0x01;
const UNIT_8: u8 = UNIT | 0x01;
const REPORT_SIZE_8: u8 = REPORT_SIZE | 0x01;
const REPORT_ID_8: u8 = REPORT_ID | 0x01;
const REPORT_COUNT_8: u8 = REPORT_COUNT | 0x01;
const COLLECTION_8: u8 = COLLECTION | 0x01;
const HIDINPUT_8: u8 = HIDINPUT | 0x01;
const FEATURE_8: u8 = FEATURE | 0x01;

// 2-byte data (bSize = 2)
const USAGE_PAGE_16: u8 = USAGE_PAGE | 0x02;
const LOGICAL_MAXIMUM_16: u8 = LOGICAL_MAXIMUM | 0x02;
const PHYSICAL_MAXIMUM_16: u8 = PHYSICAL_MAXIMUM | 0x02;
const REPORT_COUNT_16: u8 = REPORT_COUNT | 0x02;
const UNIT_16: u8 = UNIT | 0x02;

// 4-byte data (bSize = 3, HID encodes "4 bytes" as bSize value 3)
const LOGICAL_MAXIMUM_32: u8 = LOGICAL_MAXIMUM | 0x03;
const PHYSICAL_MAXIMUM_32: u8 = PHYSICAL_MAXIMUM | 0x03;
...
mod tests {
    ...
    /// The original PoC descriptor, byte-for-byte. Ensures the named-constant
    /// rewrite produces identical output.
    #[rustfmt::skip]
    const ORIGINAL: &[u8] = &[
        0x05, 0x0d, 0x09, 0x05, 0xa1, 0x01,
        0x85, 0x05,
        0x09, 0x22,
        0xa1, 0x02, 0x25, 0x01, 0x09, 0x47, 0x09, 0x42,
        ...
        0x05, 0x0d, 0x09, 0x22, 0xa1, 0x02, 0x25, 0x01,
        0x09, 0x47, 0x09, 0x42,
        0x95, 0x02, 0x75, 0x01, 0x81, 0x02,
        0x75, 0x01, 0x95, 0x06, 0x81, 0x03,
        0x95, 0x01, 0x75, 0x20,
        ...
        0x05, 0x09, 0x09, 0x01, 0x25, 0x01, 0x75, 0x01,
        0x81, 0x02, 0x95, 0x07, 0x81, 0x03,
        0x05, 0x0d, 0x85, 0x07,
        0x09, 0x55, 0x09, 0x59,
        0x15, 0x00, 0x26, 0xff, 0x00,
        0x75, 0x08, 0x95, 0x02, 0xb1, 0x02,
        0x06, 0x00, 0xff, 0x85, 0x08,
    ...
    #[test]
    fn descriptor_matches_original() {
        assert_eq!(
            PTP_REPORT_DESCRIPTOR, ORIGINAL,
            "named-constant descriptor diverged from original byte sequence"
        );
    }
}
